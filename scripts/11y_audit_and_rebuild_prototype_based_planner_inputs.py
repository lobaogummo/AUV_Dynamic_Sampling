...
def load_inputs(missing: list[str]) -> dict[str, Any]:
    cases_path = require(STEP10F / "step10f_minimal_boundary_planner_cases.csv", "Step10F cases", missing)
    ...
    step10f_npz = np.load(require(STEP10F / "planner_minimal_boundary_input_maps.npz", "Step10F npz", missing), allow_pickle=True)
    step08_npz = np.load(require(STEP08 / "step08_all_descriptor_maps.npz", "Step08 descriptor maps", missing), allow_pickle=True)
