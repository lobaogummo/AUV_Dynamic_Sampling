...
DEFAULT_PATCH_SIZES = [(16, 16), (24, 16), (32, 20), (40, 24), (48, 32), (56, 32), (64, 36), (72, 40), (80, 44)]
...
def save_member_contact_sheets_from_png_source(
    ...
    for ci, idx in enumerate(class_indices, start=1):
        ...
        title = (
            ...
            f"[{patch_w}x{patch_h}] seed={seed}, spread=deterministic"
        )
...
def write_report(
    ...
    md = [
        ...
        f"- class members: `{(out_base / 'class_members_wXX_hYY_seedSS').relative_to(ROOT).as_posix()}`",
    ]
