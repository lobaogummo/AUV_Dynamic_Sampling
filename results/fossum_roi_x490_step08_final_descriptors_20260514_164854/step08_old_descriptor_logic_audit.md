...
- Thresholds: Otsu threshold for multi-regime prototype segmentation, gradient normalization p95, boundary proximity distance p75, single_gradient boundary proxy max_score=0.35
