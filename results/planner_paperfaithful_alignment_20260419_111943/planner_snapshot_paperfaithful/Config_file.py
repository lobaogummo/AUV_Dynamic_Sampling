...
#PAPER-FAITHFUL ALIGNMENT OPTIONS
# REQUIRED TO MATCH PAPER: apply Gaussian smoothing in pre-processing before graph generation.
APPLY_GAUSSIAN_FILTER = True
GAUSSIAN_SIGMA_X = 1.0
GAUSSIAN_SIGMA_Y = 1.0

# REQUIRED TO MATCH PAPER: single Voronoi pass over V1 generators with dmin constraint.
# Options:
# - "legacy_two_pass_threshold": original implementation with two uncertainty thresholds
# - "paper_single_pass": one Voronoi pass, no additional uncertainty thresholding
